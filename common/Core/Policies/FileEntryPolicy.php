...
class FileEntryPolicy
{
    ...
    protected function userCan(User $currentUser, string $permission, array $entryIds)
    {
        if ($currentUser->hasPermission($permission)) {
            return true;
        }

        $entries = $this->findEntries($entryIds);
    ...
    protected function findEntries(array $entryIds)
    {
